...
/** Small reference values generated with R 4.x and the ggplot2 statistical contracts vendored under
  * `vendor/ggplot2`. Keeping the fixture literal makes the same oracle run on the JVM and Scala.js.
  */
object ScientificStatParityFixture:
  ...
  /** `approx(density(0:4, bw = 1, n = 512, from = 0, to = 4), xout = seq(0, 4, 0.5))$y`.
    */
  val density: Vector[Double] =
    Vector(
      0.13988897946365283, 0.17040478922152438, 0.18825987501975672, 0.19613687188289636,
      0.19817060212962401, 0.19613687188289633, 0.18825987501975666, 0.17040478922152436,
      0.13988897946365286
    )
